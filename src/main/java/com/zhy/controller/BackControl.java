...
//        //String url= request.getSession().getAttribute("lastUrl").toString();
//        String url=null;
//        //System.err.println("从跳转首页返回了lasturl:     "+url);
//        response.setHeader("lastUrl",url=(String) request.getSession().getAttribute("lastUrl") );
//        System.err.println("从跳转首页返回了lasturl:     "+url);
//        return "index";
//    }
   ...
   public String index(){
    ...
    public void toLogin(HttpServletRequest request) {
        ...
        //System.err.println( "/toLogin 保存的url"+ lastUrl);
        if (lastUrl != null) {
            try {
