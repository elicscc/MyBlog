    ...
    //网站最后更新时间（版本更新需更改）
    var siteLastUpdateTime = '2020年02月07日19点';

    //网站开始时间
    var siteBeginRunningTime = '2020-02-06 20:00:00';
    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","person_jpg/qq.jpg");
        $('.weixin_code').attr("src","person_jpg/wx.jpg");
    });
